...
urlpatterns = [
    ...
    path('billing_profile/',login_required(views.billing_profile,login_url='login'),name='billing_profile'),
    path('billing_profile/select',login_required(views.select_billing_profile,login_url='login'),name='select_billing_profile'),
    path('billing_profile/stablish',login_required(views.stablish_billing_profile,login_url='login'),name='stablish_billing_profile'),
